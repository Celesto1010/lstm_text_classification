...
flags.DEFINE_string("model_dir", "./model", "The output file for trained model.")
...
def file_based_input_fn_builder(input_file, is_training, batch_size, num_epochs):
    ...
    def input_fn():
        ...
        labels = tf.reshape(features[2], shape=(-1,))
        features = {
...
def main():
    ...
    if FLAGS.do_train:
        ...
        train_input_fn = file_based_input_fn_builder(train_file,
                                                     is_training=True,
    ...
    if FLAGS.do_eval:
        ...
        eval_input_fn = file_based_input_fn_builder(eval_file,
                                                    is_training=False,
    ...
    if FLAGS.do_predict:
        ...
        num_eval_examples = len(predict_examples)
